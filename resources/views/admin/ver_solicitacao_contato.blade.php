            ...
            <div class="row">
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" href="/lang/{{ $mensagem->locale }}?next=/projetos/{{ $mensagem->projeto_id }}" target="_blank" aria-selected="false">Projeto <i class="bi bi-box-arrow-up-right"></i></a>
                        @endif
                    </div>
                </div>
                <div class="col-9">
