<form class="form" action="{{ route('admin.projeto.update', $projeto->id) }}"  method="post" enctype="multipart/form-data">
    ...
    <div class="row gap-4 mt-4">
        ...
        <div class="mb-3">
            ...
            <small class="text-danger">A última imagem será a capa na tela do projeto em <a href={{ route('projetos') }}>Projetos</a> e deve ser de resolução 400x500 ou aproximado</small><br>
